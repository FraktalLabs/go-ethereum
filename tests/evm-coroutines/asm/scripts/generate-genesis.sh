...
SPAWNC_INNER_BIN=$($EVM_BIN compile $WORK_DIR/spawnc-inner-func.txt)
echo "Spawnc inner function code: $SPAWNC_INNER_BIN"
...
sed -i -e "s|<SPAWNC_INNER_FUNC_CODE>|0x$SPAWNC_INNER_BIN|" $WORK_DIR/genesis.json
